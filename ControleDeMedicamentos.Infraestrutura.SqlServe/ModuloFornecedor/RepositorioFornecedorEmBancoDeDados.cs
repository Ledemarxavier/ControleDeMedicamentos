...
namespace ControleDeMedicamentos.Infraestrutura.BancoDeDados.ModuloFornecedor;

public class RepositorioFornecedorEmBancoDeDados(IDbConnection connection) : IRepositorioFornecedor
{

...
namespace ControleDeMedicamentos.Infraestrutura.BancoDeDados.ModuloFuncionario;

public class RepositorioFuncionarioEmBancoDeDados(IDbConnection connection) : IRepositorioFuncionario
{
